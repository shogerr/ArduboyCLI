  ...
  switch (er.code) {
    case 'ECONNREFUSED':
      ...
      detail.push([
        ...
        [
          ...
          "'proxy' config is set properly.  See: 'arduboy help config'"
        ].join('\n')
      ])
      break
    ...
    case 'ELIFECYCLE':
      ...
      detail.push([
        ...
        [
          ...
          'Make sure you have the latest version of node.js and arduboy installed.',
          'If you do, this is most likely a problem with the ' + er.pkgname + ' package,',
          'not with arduboy itself.',
          'Tell the author that this fails on your system:',
          '    ' + er.script,
          'You can get information on how to open an issue for this project with:',
          '    arduboy bugs ' + er.pkgname,
          'Or if that isn\'t available, you can get their info via:',
          '    arduboy owner ls ' + er.pkgname,
    ...
    case 'ENOGIT':
      ...
      detail.push([
        ...
        [
          '',
          'Failed using git.',
          'This is most likely not a problem with arduboy itself.',
    ...
    case 'E404':
      ...
      if (er.pkgid && er.pkgid !== '-') {
        detail.push(['404', ''])
        detail.push(['404', '', "'" + er.pkgid + "' is not in the arduboy registry."])
    ...
    case 'EPUBLISHCONFLICT':
      ...
      detail.push(['publish fail', '    arduboy help version'])
      break
    ...
    case 'ECYCLE':
      ...
      detail.push([
        'cycle',
        [
          'Found a pathological dependency case that arduboy cannot solve.',
    ...
    case 'ENEEDAUTH':
      ...
      detail.push(['need auth', 'You need to authorize this machine using `arduboy adduser`'])
      break
    ...
    case 'ENOPACKAGEJSON':
      ...
      detail.push([
        ...
        [
          'This is most likely not a problem with arduboy itself.',
          "arduby can't find a package.json file in your current directory."
        ].join('\n')
      ])
      break
    ...
    case 'ENOTSUP':
      if (er.required) {
        ...
        short.push(['notsup', 'Not compatible with your version of node/arduboy: ' + er.pkgid])
        detail.push([
          'notsup',
          [
            'Not compatible with your version of node/arduboy: ' + er.pkgid,
            'Required: ' + JSON.stringify(er.required),
            'Actual:   ' + JSON.stringify({
              arduboy: arduboy.version,
              node: arduboy.config.get('node-version')
            })
          ].join('\n')
        ])
        break
    ...
    case 'ENOENT':
      ...
      detail.push([
        ...
        [
          er.message,
          'This is most likely not a problem with arduboy itself',
          'and is related to arduboy not being able to find a file.',
    ...
    case 'ETOOMANYARGS':
      ...
      detail.push([
        'typeerror',
        [
          'This is an error with arduboy itself. Please report this error at:',
          '    <http://github.com/rogosher/ArduboyCLI/issues>'
        ].join('\n')
      ])
      break
    ...
    case 'EISDIR':
      ...
      detail.push([
        ...
        [
          'This is most likely not a problem with arduboy itself',
          'and is related to arduboy not being able to find a package.json in',
    ...
    default:
      ...
      detail.push([
        ...
        [
          ...
          '    <https://github.com/rogosher/ArduboyCLI/issues>'
        ].join('\n')
      ])
      break
  }
